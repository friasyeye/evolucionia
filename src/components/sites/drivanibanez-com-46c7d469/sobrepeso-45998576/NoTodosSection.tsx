...
const METAB = [
  { title: "Metabolismo rápido", text: "Quema más calorías en reposo y responde bien a los carbohidratos." },
  { title: "Metabolismo lento", text: "Requiere menos calorías y quema mejor grasas que carbohidratos." },
];
                ...
                <Reveal key={m.title}>
                  <div className="h-full rounded-[6px] border border-[#07357e]/20 p-5">
                    <div className="flex items-center gap-2">
                      ...
                      <h3 className="font-tight text-[18px] font-semibold text-[#07357e]">{m.title}</h3>
                    </div>

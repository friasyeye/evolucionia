  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[1200px]">
        <Reveal
          as="h2"
          className="font-tight mx-auto max-w-[24ch] text-center text-[clamp(1.7rem,3vw,2.4rem)] font-semibold leading-[1.1] text-white"
        >
          El problema no suele ser la falta de esfuerzo. Es aplicar soluciones genéricas a un
          metabolismo que es único.
        </Reveal>

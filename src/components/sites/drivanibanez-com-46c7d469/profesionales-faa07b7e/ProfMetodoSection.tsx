...
export function ProfMetodoSection() {
  return (
    <section
    ...
    >
      <div className="mx-auto w-full max-w-[1100px]">
        ...
        <Reveal className="mx-auto mt-10 max-w-[620px] space-y-2 text-center text-[17px] text-white/85">
          <p>No todas las personas queman grasa igual.</p>
          <p>No todas responden igual a una dieta.</p>
          <p>Y no todas necesitan entrenar más.</p>
        </Reveal>
